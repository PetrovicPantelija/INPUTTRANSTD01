...
namespace TrackModal.Izvestaji
{
    public partial class frmDodatniList : Form
    {
        ...
        {
            TrackModalDataSetTableAdapters.SelectDodatniListTableAdapter ta = new TrackModalDataSetTableAdapters.SelectDodatniListTableAdapter();
            
            TrackModalDataSet.SelectDodatniListDataTable dt = new TrackModalDataSet.SelectDodatniListDataTable();
        ...
        {
            frmDodatniList dodatnilist = new frmDodatniList();
            this.Close();
        }
