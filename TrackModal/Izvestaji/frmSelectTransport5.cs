...
namespace TrackModal.Izvestaji
{
    public partial class frmSelectTransport5 : Form
    {
        ...
        {
            TrackModalDataSet18TableAdapters.SelectTransport5TableAdapter ta = new TrackModalDataSet18TableAdapters.SelectTransport5TableAdapter();
            TrackModalDataSet18.SelectTransport5DataTable dt = new TrackModalDataSet18.SelectTransport5DataTable();
        ...
        {
            frmSelectTransport5 select5 = new frmSelectTransport5();
            this.Close();
        }
