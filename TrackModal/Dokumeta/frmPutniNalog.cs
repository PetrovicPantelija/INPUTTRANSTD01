...
namespace TrackModal.Dokumeta
{
  ...
  " FROM [dbo].[PutniNalogKvarovi]" +
        ...
        {
            TrackModalDataSet14TableAdapters.SelectPutniNalogTransportTableAdapter ta = new TrackModalDataSet14TableAdapters.SelectPutniNalogTransportTableAdapter();
            TrackModalDataSet14.SelectPutniNalogTransportDataTable dt = new TrackModalDataSet14.SelectPutniNalogTransportDataTable();
