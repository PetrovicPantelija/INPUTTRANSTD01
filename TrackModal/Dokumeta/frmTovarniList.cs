...
namespace TrackModal.Dokumeta
{
    public partial class frmTovarniList : Form
    {
        ...
        {
            TrackModalDataSet16TableAdapters.SelectTovarniListTableAdapter ta = new TrackModalDataSet16TableAdapters.SelectTovarniListTableAdapter();
            TrackModalDataSet16.SelectTovarniListDataTable dt = new TrackModalDataSet16.SelectTovarniListDataTable();
