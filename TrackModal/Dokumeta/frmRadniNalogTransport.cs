...
namespace TrackModal.Dokumeta
{
    public partial class frmRadniNalogTransport : Form
    {
     ...
     " ,[Potpisao]  FROM[dbo].[RadniNalogTransportStavke] IdNadredjenog = " + txtSifra.Text + " order by RB";
        ...
        {
            TrackModalDataSet12TableAdapters.SelectRadniNalogTransportTableAdapter ta = new TrackModalDataSet12TableAdapters.SelectRadniNalogTransportTableAdapter();
            TrackModalDataSet12.SelectRadniNalogTransportDataTable dt = new TrackModalDataSet12.SelectRadniNalogTransportDataTable();


            TrackModalDataSet13TableAdapters.SelectRadniNalogTransportStavkeTableAdapter tal = new TrackModalDataSet13TableAdapters.SelectRadniNalogTransportStavkeTableAdapter();
            TrackModalDataSet13.SelectRadniNalogTransportStavkeDataTable dtl = new TrackModalDataSet13.SelectRadniNalogTransportStavkeDataTable();
