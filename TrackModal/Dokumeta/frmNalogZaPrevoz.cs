...
namespace TrackModal.Dokumeta
{
  ...
  " FROM [dbo].[NajavaPrevoza]    where ID = " + ID, con);
        ...
        {
            TrackModalDataSet11TableAdapters.SelectNajavaPrevozaTableAdapter ta = new TrackModalDataSet11TableAdapters.SelectNajavaPrevozaTableAdapter();
            TrackModalDataSet11.SelectNajavaPrevozaDataTable dt = new TrackModalDataSet11.SelectNajavaPrevozaDataTable();
